...
/-!
# A positive proportion of the zeros in a short interval lie away from the edges of the strip

**DRAFT.**  This is the Challenge module of an intended Palomar Registry submission.  It is not
