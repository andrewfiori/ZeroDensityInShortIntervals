...
# This file was *autogenerated* from the file /home/algie/lean-projects/ZerosInShortIntervals/Code/verify_Phi_one_bound.sage
from sage.all_cmdline import *   # import sage library

_sage_const_300 = Integer(300); _sage_const_10 = Integer(10); _sage_const_40 = Integer(40); _sage_const_2 = Integer(2); _sage_const_70 = Integer(70); _sage_const_1 = Integer(1)
CBF = ComplexBallField(_sage_const_300 )
...
delta = RBF(_sage_const_10 ) ** (-_sage_const_40 )
d = delta
near_bound = -d * d.log() + d + d * d / _sage_const_2   # closed form of int_0^delta [-log t + t] dt (+ t^2/2 slack)

# ---- Piece (2): [1+delta, T], via certified adaptive quadrature ----
T = RBF(_sage_const_70 )
f = lambda x, analytic: CBF(x).zeta().log()
I_mid = CBF.integral(f, CBF(_sage_const_1 ) + CBF(delta), CBF(T))

# ---- Piece (3): [T, infinity), via the tail bound derived above ----
tail_bound = (_sage_const_1  + _sage_const_2  / (T - _sage_const_1 )) * _sage_const_2  ** (-T) / RBF(_sage_const_2 ).log()
